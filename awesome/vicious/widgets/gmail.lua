...
local function worker(format, warg)
    ...
    local f = io.popen("bash -c \"curl -b <(sqlite3 -separator $'\\t' ~/.config/google-chrome/Default/Cookies \\\"select host_key, 'TRUE','/', 'FALSE', expires_utc, name, value from cookies where host_key like '%mail.google.com%'\\\"; ) --connect-timeout 1 -m 3 -fsn " .. feed[1] .. "\"")
